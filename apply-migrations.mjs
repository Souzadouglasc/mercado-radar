...
const supabase = createClient(
  'https://ufvatsvbvpnvueefpnaw.supabase.co',
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVmdmF0c3ZidnBuenVlZWZwYWl3Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1ODU2ODg0NywiZXhwIjoyMDc0MTQ0ODQ3fQ.RcHmM8n3qK_7UQUZ5XqPwH0XhjKl_o-XVQqZ2a7zTDz0'
);

// Migration 0004_sao-jose.sql
const m004 = `
update markets
